...
class WebDriver:
    def __init__(self, phone: str, proxy: str):
        ...
        self.chrome_options.add_argument("--user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.5945.86 Safari/537.36")
...
class LoginWindow(QtWidgets.QWidget):
    ...
    def check_login(self):
        ...
        is_valid_user = self.db_conn.check_user(login=login, password=password)
        if is_valid_user:
